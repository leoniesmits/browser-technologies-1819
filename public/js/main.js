...
if (window.XMLHttpRequest) {
  console.log("yes")
  var formRequest1 = fetch('http://localhost:2000/quiz/1', {method: 'GET'}).then(function(response) {
  ...
  var formRequest2 = fetch('http://localhost:2000/quiz/2', {method: 'POST'}).then(function(response) {
      return response.text()})
      .then(function(html) {
        var parser = new DOMParser();
        var doc = parser.parseFromString(html, "text/html");
